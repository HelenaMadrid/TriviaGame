...
var questions = {
    One: {
        ...
        AnswerIncorrect: function () {
            ...
            clearInterval(secondsLeft);
            $("#show-number").text(number);
            question.html("<h3>Nope!</h3><p>The correct answer was " + questions.One.correctAnswer + ".</p><br><img src='https://images.immediate.co.uk/volatile/sites/3/2019/02/1-2-ac324ad.jpg?quality=45&resize=620,413' class='col-xl-6 col-lg-6 col-md-6 col-sm-6'>");
            hide();
            nextQuestion = setInterval(questions.Two.thirtySeconds, 3000);
            //questions.Two.thirtySeconds();
        },
    ...
    Two: {
        ...
        AnswerIncorrect: function () {
            ...
            clearInterval(secondsLeft);
            $("#show-number").text(number);
            question.html("<h3>Nope!</h3><p>The correct answer was " + questions.Two.correctAnswer + ".</p><br><img src='https://images.immediate.co.uk/volatile/sites/3/2019/02/1-2-ac324ad.jpg?quality=45&resize=620,413' class='col-xl-6 col-lg-6 col-md-6 col-sm-6'>");
            hide();
            nextQuestion = setInterval(questions.Three.thirtySeconds, 3000);
            //questions.Two.thirtySeconds();
        },
    ...
    Three: {
        ...
        AnswerIncorrect: function () {
            ...
            clearInterval(secondsLeft);
            $("#show-number").text(number);
            question.html("<h3>Nope!</h3><p>The correct answer was " + questions.Three.correctAnswer + ".</p><br><img src='https://images.immediate.co.uk/volatile/sites/3/2019/02/1-2-ac324ad.jpg?quality=45&resize=620,413' class='col-xl-6 col-lg-6 col-md-6 col-sm-6'>");
            hide();
            nextQuestion = setInterval(questions.Four.thirtySeconds, 3000);
            //questions.Two.thirtySeconds();
        },
    ...
    Five: {
        ...
        AnswerIncorrect: function () {
            ...
            clearInterval(secondsLeft);
            $("#show-number").text(number);
            question.html("<h3>Nope!</h3><p>The correct answer was " + questions.Five.correctAnswer + ".</p><br><img src='https://images.immediate.co.uk/volatile/sites/3/2019/02/1-2-ac324ad.jpg?quality=45&resize=620,413' class='col-xl-6 col-lg-6 col-md-6 col-sm-6'>");
            hide();
            nextQuestion = setInterval(questions.Six.thirtySeconds, 3000);
            //questions.Two.thirtySeconds();
        },
    ...
    Six: {
        ...
        AnswerIncorrect: function () {
            ...
            clearInterval(secondsLeft);
            $("#show-number").text(number);
            question.html("<h3>Nope!</h3><p>The correct answer was " + questions.Six.correctAnswer + ".</p><br><img src='https://images.immediate.co.uk/volatile/sites/3/2019/02/1-2-ac324ad.jpg?quality=45&resize=620,413' class='col-xl-6 col-lg-6 col-md-6 col-sm-6'>");
            hide();
            nextQuestion = setInterval(questions.Seven.thirtySeconds, 3000);
            //questions.Two.thirtySeconds();
        },
    ...
    Seven: {
        ...
        AnswerIncorrect: function () {
            ...
            clearInterval(secondsLeft);
            $("#show-number").text(number);
            question.html("<h3>Nope!</h3><p>The correct answer was " + questions.Seven.correctAnswer + ".</p><br><img src='https://images.immediate.co.uk/volatile/sites/3/2019/02/1-2-ac324ad.jpg?quality=45&resize=620,413' class='col-xl-6 col-lg-6 col-md-6 col-sm-6'>");
            hide();
            nextQuestion = setInterval(questions.Eight.thirtySeconds, 3000);
            //questions.Two.thirtySeconds();
        },
    ...
    Eight: {
        ...
        AnswerIncorrect: function () {
            ...
            clearInterval(secondsLeft);
            $("#show-number").text(number);
            question.html("<h3>Nope!</h3><p>The correct answer was " + questions.Eight.correctAnswer + ".</p><br><img src='https://images.immediate.co.uk/volatile/sites/3/2019/02/1-2-ac324ad.jpg?quality=45&resize=620,413' class='col-xl-6 col-lg-6 col-md-6 col-sm-6'>");
            hide();
            nextQuestion = setInterval(questions.Nine.thirtySeconds, 3000);
            //questions.Two.thirtySeconds();
        },
    ...
    Nine: {
        ...
        AnswerIncorrect: function () {
            ...
            clearInterval(secondsLeft);
            $("#show-number").text(number);
            question.html("<h3>Nope!</h3><p>The correct answer was " + questions.Nine.correctAnswer + ".</p><br><img src='https://images.immediate.co.uk/volatile/sites/3/2019/02/1-2-ac324ad.jpg?quality=45&resize=620,413' class='col-xl-6 col-lg-6 col-md-6 col-sm-6'>");
            hide();
            nextQuestion = setInterval(questions.Ten.thirtySeconds, 3000);
            //questions.Two.thirtySeconds();
        },
    ...
    Ten: {
        ...
        AnswerIncorrect: function () {
            ...
            clearInterval(secondsLeft);
            $("#show-number").text(number);
            question.html("<h3>Nope!</h3><p>The correct answer was " + questions.Ten.correctAnswer + ".</p><br><img src='https://images.immediate.co.uk/volatile/sites/3/2019/02/1-2-ac324ad.jpg?quality=45&resize=620,413' class='col-xl-6 col-lg-6 col-md-6 col-sm-6'>");
            hide();
            nextQuestion = setInterval(questions.results, 3000);
            //questions.Two.thirtySeconds();
        },
    ...
    results: function () {
        ...
        clockRunning = false;
        clearInterval(secondsLeft);
        question.html("<h3>All done, here's how you did!</h3><br><p>Correct Answers: " + correctCounter + "</p><br><p>Incorrect Answers: " + incorrectCounter + "</p><br><p>Unanswered: </p><br><button class='h3'>Start Over?</button>");
